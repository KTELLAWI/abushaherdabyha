...
class WooWidget extends BaseFrameworks
  ...
  Widget renderVariantItemEnglish(BuildContext context, String name, String? option) {
     String englishName = "" ;
      if (name == 'الحجم' ){
        englishName = "size";
      } 

      else if (name == "التقطيع")
      {
        englishName = "chopping";
      }
      else if (name == "التغليف"){
        englishName= "packaging";
      }
    else if (name == "الراس"){
        englishName = "head";
      }
      ...
      children: <Widget>[
        ConstrainedBox(
          ...
          child: Text(
            ...
            "${englishName[0].toUpperCase()}${englishName.substring(1)} ",
 ...
 list.add(renderVariantItemEnglish(context, key, '${options[key]}'));
        list.add(const SizedBox(
          height: 5.0,
        ));
        }
