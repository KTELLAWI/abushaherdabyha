...
class QuantitySelection1 extends StatefulWidget {
  ...
  @override
  State<QuantitySelection1> createState() => _QuantitySelection1State();
}

class _QuantitySelection1State extends State<QuantitySelection1> {
  ...
  @override
  void didUpdateWidget(covariant QuantitySelection1 oldWidget) {
