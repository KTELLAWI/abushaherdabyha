  ...
  Widget renderAttributes() {
    return Consumer<FilterAttributeModel>(
      builder: (context, value, child) {
        catId = catId!= null ? catId : categoryId;
        printLog(value.lstProductAttribute![0].name);
        printLog(value.lstProductAttribute![0].slug);
        printLog(value.lstProductAttribute![0].id);
