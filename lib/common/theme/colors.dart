...
/// Color env config
Color? get darksideMenuColor =>
    (kDarkConfig.sideMenuColor?.isNotEmpty ?? false)
        ? HexColor(kDarkConfig.sideMenuColor)
        : null;
...
Color? get lightSecondaryColor =>
    (kLightConfig.secondaryColor?.isNotEmpty ?? false)
        ...
        : null;
Color? get lightsideMenuColor =>
    (kLightConfig.sideMenuColor?.isNotEmpty ?? false)
        ? HexColor(kLightConfig.sideMenuColor)
        : null;
/// Color theme
