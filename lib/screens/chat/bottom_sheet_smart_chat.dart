    ...
    return Align(
      ...
      child: Padding(
        ...
        child: ScaleTransition(
          ...
          child: FloatingActionButton(
            heroTag: null,
            backgroundColor:   !Provider.of<AppModel>(context, listen: true).darkTheme? Color(0xff52260f) :Color(0xffeac85f),//Theme.of(context).primaryColorLight,// : Color(0xff52260f),//Colors.white,//Theme.of(context).backgroundColor,
            onPressed: () async {
            ...
            child: Icon(
              Icons.chat,
              color:!Provider.of<AppModel>(context, listen: true).darkTheme ? Color(0xffeac85f): Color(0xff52260f), //Color(0xff52260f),//Colors.black,//Theme.of(context).backgroundColor,
              size: 35,
            ),
          ),
        ),
