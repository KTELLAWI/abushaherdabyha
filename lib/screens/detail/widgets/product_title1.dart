...
class ProductTitle1 extends StatefulWidget {
  final Product? product;

  const ProductTitle1(this.product);

  @override
  BaseScreen<ProductTitle1> createState() => _ProductTitle1State();
}

class _ProductTitle1State extends BaseScreen<ProductTitle1> {
  var regularPrice;
  //bool onSale = false;
  //int sale = 100;
  String? price;
