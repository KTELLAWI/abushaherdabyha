...
class S {
  ...
  String get seeAll {
    ...
    /// `delivery time`
  String get insertDeliveryTime {
    return Intl.message(
      'Please insert Delivery Date properly',
      name: 'insertDeliveryTime',
      desc: '',
      args: [],
    );
  }
      /// `delivery date`
  String get deliveryZaman {
    return Intl.message(
      'Delivery Date',
      name: 'deliveryZaman',
      desc: '',
  ...
  String get streetNameApartment {
    ...
    /// `Building`
  String get streetNameBuilding {
    return Intl.message(
      'Building',
      name: 'streetNameBuilding',
      desc: '',
      args: [],
    );
  }
